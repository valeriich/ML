...
def id3(data, uniqs, remaining_atts, target_attribute):
    ...
    for remaining_att in remaining_attributes:
...
if __name__ == "__main__":
    config = {"data_file": "/tennis.csv", "data_project_columns": ['Outlook', 'Temperature', 'Humidity', 'Windy', 'PlayTennis'], 'target_attribute': 'PlayTennis' }
